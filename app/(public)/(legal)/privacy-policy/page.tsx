...
export const metadata = {
  title: "Privacy Policy - DreamSellers",
  description: "This page outlines the privacy practices of DreamSellers, detailing how we collect, use, and protect your personal information.",
  keywords: ["dreamsellers", "privacy policy", "real estate", "property"],
  ...
  return (    
    <section className="space-y-6">
      <div className="max-w-3xl mx-auto py-16 px-3 sm:px-8 space-y-4">
        ...
        <p className="">
          DreamSellers (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website https://dreamseller.ca and engage with our real estate services. Please read this policy carefully to understand our practices.
        </p>
        ...
        <ul className="list-inside list-disc space-y-2 pl-4">
          <li>
            <strong>a. Personal Data:</strong> When you contact us about properties, leave comments, or subscribe to our services, we collect your name, email address, phone number, and property preferences.
          </li>
          <li>
          ...
          <li>
            <strong>f. Property Inquiries:</strong> When you inquire about properties, we collect information about your property preferences, budget, and timeline.
          </li>
        </ul>
        ...
        <ul className="list-inside list-disc space-y-2 pl-4">
          ...
          <li>Send newsletters and property updates (with your consent)</li>
        ...
        <p className="">
          Articles on this site may include embedded content (e.g., videos, images, articles, property listings). Embedded content from other websites behaves the same as if the visitor has visited that website. These websites may collect data about you, use cookies, and monitor your interaction with embedded content, including tracking your interactions if you are logged in to their website.
        </p>
        ...
        <ul className="list-inside list-disc space-y-2 pl-4">
          ...
          <li>With Property Partners: When necessary to facilitate property viewings or transactions (with your consent).</li>
        ...
        <p className="">
          If you leave a comment, the comment and its metadata are retained indefinitely to recognize and approve follow-up comments automatically. For registered users, we store the personal information provided in their user profile, which can be viewed, edited, or deleted at any time (except the username). Property inquiry data is retained for up to 5 years to provide ongoing service. Administrators can also view and edit this information.
        </p>
